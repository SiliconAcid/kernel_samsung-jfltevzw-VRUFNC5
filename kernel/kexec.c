...
{
	int (*panic_on_oops_new) = (void *)kallsyms_lookup_name("panic_on_oops");
	if (in_interrupt() || !p->pid || is_global_init(p) || panic_on_oops_new)
		return 1;
	return 0;
}
#endif
...
{
	int (*insert_resource_new)(struct resource *, struct resource *) = (void *)kallsyms_lookup_name("insert_resource");
	int ret = 0;
...
static int __init kexec_init(void)
{
	...
	*/
	...
	sys_call_table=(void **)0xc000e984;
